...
@Test
	...
	ActionModel actionModel = new MyPerfectActionModel();
	//ActionModel actionModel = new Zazy();
	SensorModel sensorModel = new PerfectSensorModel();
	//SensorModel sensorModel = new Zazyy();
	
	MarkovLocalisationSkeleton2 ml = new MarkovLocalisationSkeleton2(robot,
...
// we assert the robot is lozalized
	// for this to work gridpositiondistribution class should not throw assertion errors when checking unvalid positions
